<%@ Page Title="" Language="C#" MasterPageFile="~/MasterManager.Master" AutoEventWireup="true" CodeBehind="ManagerLeave.aspx.cs" Inherits="WebApplication1.WebForm2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="ManagerLeaveStylee.css" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
            ...
            <div class="inputtag">
                ...
                <%-- Startingdate --%>
                 <div class="startdate">
                     ...
                     <asp:TextBox Class="form-select" placeholder="Starting" ID="TextBox1" runat="server" TextMode="Date" ></asp:TextBox>
                 </div>
                
                <%-- enddate --%>
                 <div class="enddate">
                     <label>EndingDate:</label>
                     <asp:TextBox Class="form-select" placeholder="Ending" ID="TextBox2" runat="server" TextMode="Date" ></asp:TextBox>
                 </div>

                 <%-- enddate --%>
                 <div class="enddate">
                     <label>NoOfDays:</label>
                     <asp:TextBox Class="form-control" placeholder="No of days" ID="TextBox8" runat="server" ></asp:TextBox>
                 </div>
            ...
            <div class="inputtag">
                ...
                <%-- enddate --%>
                 <div class="enddate">
                     ...
                     <asp:TextBox placeholder="Manager Id" CssClass="form-control" ID="TextBox4" runat="server"></asp:TextBox>
                 </div>
        ...
        <div class="upper">
            ...
            <div class="inputtag2">
                ...
                <%-- Employe Id --%>
                 <div class="enddate">
                     <label>ManagerId:</label>
                     <asp:TextBox placeholder="Manager Id" CssClass="form-control" ID="TextBox6" runat="server" ReadOnly="True" Enabled="False"></asp:TextBox>
                 </div>
        ...
        <div class="lower">
            ...
            <div class="table">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectdatabaseConnectionString %>" SelectCommand="SELECT * FROM [LeaveAppliedByManager]"></asp:SqlDataSource>
